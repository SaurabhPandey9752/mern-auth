...
export default function Home() {
  return (
    <div className='px-4 py-12 max-w-2xl mx-auto dark:bg-gray-900 dark:text-white'>
      <h1 className='text-3xl font-bold mb-4 text-slate-800 dark:text-white'>Welcome to my Auth App!</h1>
