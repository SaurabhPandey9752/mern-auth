...
export default function Profile() {
  ...
  return (
    <div className='p-3 max-w-lg mx-auto dark:bg-gray-900 dark:text-white'>
      <h1 className='text-3xl font-semibold text-center my-7 text-slate-800 dark:text-white'>Profile</h1>
      <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
        ...
        <p className='text-sm self-center'>
          {imageError ? (
            ...
            <span className='text-green-700 dark:text-green-400'>Image uploaded successfully</span>
          ) : (
            ''
          )}
        </p>
